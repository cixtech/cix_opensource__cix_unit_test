...
static const int16_t vp9_dc_qlookup_8[256] = {
    4,     8,     8,     9,    10,    11,    12,    12,
...
static const int16_t vp9_ac_qlookup_8[256] = {
...
static const int16_t vp9_dc_qlookup_10[256] = {
...
static const int16_t vp9_ac_qlookup_10[256] = {
...
typedef struct {
    ...
    int height;
    int initialized;
    VASurfaceID ref_frames[8];
    int ref_valid[8];
    int ref_width[8];
    int ref_height[8];
    int coded_bit_depth;
    VAProfile active_va_profile;
    int active_rt_bit_depth;
